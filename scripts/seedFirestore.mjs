...
// Data payloads
const users = [
  // 1. KK Putrajaya (clinic-001)
  { id: 'mo-001', name: 'Dr. Ahmad Razali', email: 'mo@healthgrid.com', role: 'Medical Officer', specialty: 'General Medicine', mmcNumber: 'MMC No. 59302', status: 'active', createdAt: '2025-02-15T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-001' },
  { id: 'admin-001', name: 'Tan Wei Ming', email: 'weiming.tan@healthgrid.my', role: 'Administrator', status: 'active', createdAt: '2024-12-01T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-001' },
  ...
  { id: 'rologist-001', name: 'Dr. Priya Nair', email: 'priya.nair@healthgrid.my', role: 'Radiologist', specialty: 'Diagnostic Radiology', mmcNumber: 'MMC No. 48291', status: 'active', createdAt: '2025-01-20T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-001' },

  // 2. KK Cyberjaya (clinic-002)
  { id: 'mo-002', name: 'Dr. Nurul Aisyah', email: 'nurul.aisyah@healthgrid.my', role: 'Medical Officer', specialty: 'Primary Care & Family Medicine', mmcNumber: 'MMC No. 61204', status: 'active', createdAt: '2025-01-10T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-002' },
  { id: 'admin-002-cb', name: 'Siti Rahmah', email: 'admin.cyberjaya@healthgrid.my', role: 'Administrator', status: 'active', createdAt: '2025-01-15T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-002' },
  ...
  { id: 'rologist-002', name: 'Dr. Kevin Wong', email: 'kevin.wong@healthgrid.my', role: 'Radiologist', specialty: 'Neuroradiology', mmcNumber: 'MMC No. 51049', status: 'active', createdAt: '2025-02-01T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-002' },

  // 3. KK Bangi (clinic-003)
  { id: 'mo-003', name: 'Dr. Haris Sulaiman', email: 'haris.sulaiman@healthgrid.my', role: 'Medical Officer', specialty: 'General Medicine', mmcNumber: 'MMC No. 58912', status: 'active', createdAt: '2025-02-20T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-003' },
  { id: 'admin-003', name: 'Azman Hashim', email: 'azman.hashim@healthgrid.my', role: 'Administrator', status: 'active', createdAt: '2025-02-01T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-003' },
  ...
  { id: 'rologist-003', name: 'Dr. Kavitha Raj', email: 'kavitha.raj@healthgrid.my', role: 'Radiologist', specialty: 'Musculoskeletal Radiology', mmcNumber: 'MMC No. 49301', status: 'active', createdAt: '2025-02-10T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-003' },

  // 4. Hospital Tanjong Karang (clinic-004)
  { id: 'mo-004', name: 'Dr. Zulkifli Rahman', email: 'zulkifli.rahman@healthgrid.my', role: 'Medical Officer', specialty: 'Emergency Medicine', mmcNumber: 'MMC No. 54388', status: 'active', createdAt: '2025-03-01T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-004' },
  { id: 'admin-004', name: 'Hamidah Ibrahim', email: 'hamidah.ibrahim@healthgrid.my', role: 'Administrator', status: 'active', createdAt: '2025-03-05T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-004' },
  ...
  { id: 'rologist-004', name: 'Dr. Chong Wei Kiat', email: 'weikiat.chong@healthgrid.my', role: 'Radiologist', specialty: 'Thoracic Radiology', mmcNumber: 'MMC No. 47210', status: 'active', createdAt: '2025-03-12T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-004' },

  // 5. KK Ijok (clinic-005)
  { id: 'mo-005', name: 'Dr. Faizah Ismail', email: 'faizah.ismail@healthgrid.my', role: 'Medical Officer', specialty: 'Family Medicine', mmcNumber: 'MMC No. 62190', status: 'active', createdAt: '2025-03-15T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-005' },
  { id: 'admin-005', name: 'Razi Shafie', email: 'razi.shafie@healthgrid.my', role: 'Administrator', status: 'active', createdAt: '2025-03-20T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-005' },
  ...
  { id: 'rologist-005', name: 'Dr. Suresh Kumar', email: 'suresh.kumar@healthgrid.my', role: 'Radiologist', specialty: 'Abdominal Radiology', mmcNumber: 'MMC No. 46811', status: 'active', createdAt: '2025-03-25T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-005' },

  // 6. KK Bestari Jaya (clinic-006)
  { id: 'mo-006', name: 'Dr. Michelle Tan', email: 'michelle.tan@healthgrid.my', role: 'Medical Officer', specialty: 'Community Health', mmcNumber: 'MMC No. 63401', status: 'active', createdAt: '2025-04-01T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-006' },
  { id: 'admin-006', name: 'Noraishah Daud', email: 'noraishah.daud@healthgrid.my', role: 'Administrator', status: 'active', createdAt: '2025-04-05T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-006' },
  { id: 'rad-009', name: 'Tan Li Wen', email: 'liwen.tan@healthgrid.my', role: 'Radiographer', status: 'active', createdAt: '2025-08-15T08:00:00Z', shift: 'Day', leaveStatus: 'Active', supportedModalities: ['X-Ray', 'MRI', 'CT', 'Ultrasound'], deploymentLocationId: 'clinic-006' },
  { id: 'rologist-006', name: 'Dr. Amira Latiff', email: 'amira.latiff@healthgrid.my', role: 'Radiologist', specialty: 'Pediatric Radiology', mmcNumber: 'MMC No. 53102', status: 'active', createdAt: '2025-04-10T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-006' },

  // 7. KK Bukit Cherakah (clinic-007)
  { id: 'mo-007', name: 'Dr. Hafizuddin Omar', email: 'hafizuddin.omar@healthgrid.my', role: 'Medical Officer', specialty: 'Rural Primary Healthcare', mmcNumber: 'MMC No. 64210', status: 'active', createdAt: '2025-04-15T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-007' },
  { id: 'admin-007', name: 'Kamal Hamzah', email: 'kamal.hamzah@healthgrid.my', role: 'Administrator', status: 'active', createdAt: '2025-04-20T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-007' },
  { id: 'rad-010', name: 'Anis Farhanah', email: 'anis.farhanah@healthgrid.my', role: 'Radiographer', status: 'active', createdAt: '2025-09-01T08:00:00Z', shift: 'Day', leaveStatus: 'Active', supportedModalities: ['X-Ray', 'CT', 'Ultrasound'], deploymentLocationId: 'clinic-007' },
  { id: 'rologist-007', name: 'Dr. Sarah Jenkins', email: 'sarah.jenkins@healthgrid.my', role: 'Radiologist', specialty: 'General Diagnostic Imaging', mmcNumber: 'MMC No. 52980', status: 'active', createdAt: '2025-04-25T08:00:00Z', shift: 'Day', leaveStatus: 'Active', deploymentLocationId: 'clinic-007' },
  ...
  { id: 'admin-002', name: 'Master Admin', email: 'daneshlou05@gmail.com', role: 'Administrator', status: 'active', createdAt: '2025-01-01T08:00:00Z', shift: 'Day', leaveStatus: 'Active' },
];
...
const clinics = [
  ...
  { id: 'clinic-006', name: 'Klinik Kesihatan Bestari Jaya', code: 'KK-BSJ-06', address: 'Pekan Batang Berjuntai, 45600 Bestari Jaya', city: 'Bestari Jaya', state: 'Selangor', district: 'Kuala Selangor', latitude: 3.3855, longitude: 101.4137, operatingHours: '08:00 - 17:00', phone: '+60 3-6075 2211', isMobileStation: true, status: 'active', equipmentList: ['Static X-Ray Unit'], dailyCapacity: 30 },
  { id: 'clinic-007', name: 'Klinik Kesihatan Bukit Cherakah', code: 'KK-BKC-07', address: 'Kampung Bukit Cherakah, 45800 Jeram', city: 'Jeram', state: 'Selangor', district: 'Kuala Selangor', latitude: 3.2072, longitude: 101.4633, operatingHours: '08:00 - 17:00', phone: '+60 3-6075 3344', isMobileStation: false, status: 'active', equipmentList: ['Digital X-Ray Unit'], dailyCapacity: 25 },
];
