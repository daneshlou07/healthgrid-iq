...
const patients = [
  { id: 'pat-001', icNumber: '850315-10-5231', name: 'Siti Aminah binti Hassan', dob: '1985-03-15', gender: 'Female', phone: '+60 12-345 6789', email: 'siti.aminah@gmail.com', address: 'No 12, Jalan Presint 9/3, Presint 9, 62250 Putrajaya', preferredClinicId: 'clinic-001', medicalHistory: ['Hypertension', 'No known drug allergies'], createdAt: '2025-05-01T10:00:00Z', status: 'Active', latitude: 2.9280, longitude: 101.6950 },
  { id: 'pat-002', icNumber: '920722-14-6109', name: 'Tan Kah Heng', dob: '1992-07-22', gender: 'Male', phone: '+60 16-234 5678', email: 'kahheng.tan@yahoo.com', address: 'B-12-3, Eclipse Residence, Persiaran Multimedia, 63000 Cyberjaya', preferredClinicId: 'clinic-002', medicalHistory: ['Asthma'], createdAt: '2025-05-10T14:30:00Z', status: 'Active', latitude: 2.9230, longitude: 101.6580 },
  { id: 'pat-003', icNumber: '781104-08-3347', name: 'Muthusamy a/l Ramasamy', dob: '1978-11-04', gender: 'Male', phone: '+60 19-876 5432', email: 'muthu.ramasamy@outlook.com', address: 'No 45, Jalan 4/12, Seksyen 4, 43650 Bandar Baru Bangi', preferredClinicId: 'clinic-003', medicalHistory: ['Type 2 Diabetes', 'Penicillin allergy'], createdAt: '2025-06-02T09:15:00Z', status: 'Active', latitude: 2.9490, longitude: 101.7610 },
  { id: 'pat-004', icNumber: '951230-10-5582', name: 'Nurul Huda binti Mohd Zain', dob: '1995-12-30', gender: 'Female', phone: '+60 13-456 7890', email: 'huda.zain@gmail.com', address: 'No 8, Jalan Bestari 2/1, 45600 Bestari Jaya', preferredClinicId: 'clinic-005', medicalHistory: ['None'], createdAt: '2025-06-15T11:45:00Z', status: 'Active', latitude: 3.3650, longitude: 101.3860 },
  { id: 'pat-005', icNumber: '680418-10-5123', name: 'Wong Ah Kow', dob: '1968-04-18', gender: 'Male', phone: '+60 17-654 3210', email: 'ahkow.wong@hotmail.com', address: 'No 88, Jalan Hospital, 45500 Tanjong Karang', preferredClinicId: 'clinic-004', medicalHistory: ['Hypertension', 'Hyperlipidemia'], createdAt: '2025-07-01T08:30:00Z', status: 'Active', latitude: 3.4250, longitude: 101.1840 },
];

const cases = [
  { id: 'case-001', caseNumber: 'CAS-2026-0001', patientId: 'pat-001', patientName: 'Siti Aminah binti Hassan', patientIc: '850315-10-5231', scanType: 'Chest X-Ray', clinicId: 'clinic-001', clinicName: 'Klinik Kesihatan Putrajaya', status: 'COMPLETED', priority: 'Medium', severity: 'Moderate', indication: 'Persistent Cough & Mild Fever', bodyRegion: 'Chest', radiographerId: 'rad-001', radiographerName: 'Ahmad Razak', radiologistId: 'rologist-001', radiologistName: 'Dr. Priya Nair', registeredById: 'dept-001', createdAt: '2026-07-01T09:00:00Z', scheduledAt: '2026-07-02T10:00:00Z', uploadedAt: '2026-07-02T11:30:00Z', reviewedAt: '2026-07-02T14:00:00Z', notes: 'Patient reports cough for 2 weeks.', dicomStudyId: 'STUDY-2026-001' },
  { id: 'case-002', caseNumber: 'CAS-2026-0002', patientId: 'pat-002', patientName: 'Tan Kah Heng', patientIc: '920722-14-6109', scanType: 'Brain MRI', clinicId: 'clinic-002', clinicName: 'Klinik Kesihatan Cyberjaya', status: 'IN_PROGRESS', priority: 'High', severity: 'Severe', indication: 'Chronic Headaches with Visual Disturbances', bodyRegion: 'Brain / Head', radiographerId: 'rad-002', radiographerName: 'Lim Mei Ling', registeredById: 'dept-001', createdAt: '2026-07-05T11:00:00Z', scheduledAt: '2026-07-06T09:30:00Z', notes: 'Rule out intracranial space-occupying lesion.' },
  { id: 'case-003', caseNumber: 'CAS-2026-0003', patientId: 'pat-003', patientName: 'Muthusamy a/l Ramasamy', patientIc: '781104-08-3347', scanType: 'Abdominal CT', clinicId: 'clinic-003', clinicName: 'Klinik Kesihatan Bangi', status: 'SCHEDULED', priority: 'Urgent', severity: 'Critical', indication: 'Acute Right Lower Quadrant Abdominal Pain', bodyRegion: 'Abdomen', radiographerId: 'rad-003', radiographerName: 'Kumaran Pillai', registeredById: 'dept-001', createdAt: '2026-07-10T14:00:00Z', scheduledAt: '2026-07-29T10:00:00Z', notes: 'Suspected acute appendicitis.' },
  { id: 'case-004', caseNumber: 'CAS-2026-0004', patientId: 'pat-004', patientName: 'Nurul Huda binti Mohd Zain', patientIc: '951230-10-5582', scanType: 'Knee Ultrasound', clinicId: 'clinic-005', clinicName: 'Klinik Kesihatan Ijok', status: 'CREATED', priority: 'Low', severity: 'Mild', indication: 'Right Knee Joint Swelling Post Trauma', bodyRegion: 'Knee Joint', registeredById: 'dept-001', createdAt: '2026-07-14T08:30:00Z', notes: 'Sports injury during netball match.' },
  { id: 'case-005', caseNumber: 'CAS-2026-0005', patientId: 'pat-005', patientName: 'Wong Ah Kow', patientIc: '680418-10-5123', scanType: 'Lumbar Spine X-Ray', clinicId: 'clinic-004', clinicName: 'Hospital Tanjong Karang', status: 'CREATED', priority: 'Medium', severity: 'Moderate', indication: 'Lower Back Pain Radiating to Left Leg', bodyRegion: 'Lumbar Spine', registeredById: 'dept-001', createdAt: '2026-07-14T10:00:00Z', notes: 'History of heavy lifting.' },
];
...
async function seed() {
  console.log('🚀 Seeding Google Cloud Firestore database...');
  ...
  await batch.commit();
  console.log('✅ Google Cloud Firestore successfully seeded with all initial records!');
  process.exit(0);
}
