...
const MoPatientsList = safeLazy(() => import('./pages/mo/MoPatientsList'));
const MoPatientRegistration = safeLazy(() => import('./pages/mo/MoPatientRegistration'));
const MoNewCaseRegistration = safeLazy(() => import('./pages/mo/MoNewCaseRegistration'));
const MoAllCases = safeLazy(() => import('./pages/mo/MoAllCases'));
const MoDepartmentReports = safeLazy(() => import('./pages/mo/MoDepartmentReports'));
const MoPatientRequests = safeLazy(() => import('./pages/mo/MoPatientRequests'));
const MoTrackStatus = safeLazy(() => import('./pages/mo/MoTrackStatus'));
  ...
  return (
    <Routes>
      ...
      >
        ...
        {/* Radiology Department and Medical Officer routes */}
