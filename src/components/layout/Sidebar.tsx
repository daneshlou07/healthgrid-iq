  ...
  switch (role) {
    case 'Radiographer':
      return [
        ...
        {
          title: t('CASES', 'KES-KES'),
          items: [
            {
              label: t('My Cases', 'Kes Saya'),
              path: '/scan-queue',
        ...
        {
          title: t('ACCOUNT', 'AKAUN'),
          items: [
            {
              label: t('Onboarding', 'Panduan Pengguna'),
              path: '/onboarding',
      ...
      return [
        {
          ...
          items: [
            ...
            {
              label: t('Cases to Review', 'Kes Untuk Disemak'),
              path: '/review-queue',
              icon: <Eye className="w-[18px] h-[18px]" />,
            },
            {
              label: t('All Cases Queue', 'Senarai Semua Kes'),
              path: '/cases',
              icon: <FolderOpen className="w-[18px] h-[18px]" />,
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              label: t('Register New Case', 'Daftar Kes Baharu'),
              path: '/cases/new',
              icon: <FileText className="w-[18px] h-[18px]" />,
            },
            {
              label: t('Patient Requests', 'Permohonan Pesakit'),
              path: '/requests',
        ...
        {
          title: t('PATIENTS & REPORTS', 'PESAKIT & LAPORAN'),
          items: [
            {
              label: t('Patient Registry', 'Daftar Induk Pesakit'),
              path: '/patients',
              icon: <Users className="w-[18px] h-[18px]" />,
            },
            {
              label: t('Diagnostic Reports', 'Laporan Diagnostik'),
              path: '/reports',
              icon: <FileText className="w-[18px] h-[18px]" />,
            },
            {
      ...
      return [
        {
          ...
          items: [
            ...
            {
              label: t('Review Queue', 'Peti Masuk'),
              path: '/review-queue',
              icon: <Eye className="w-[18px] h-[18px]" />,
            },
          ],
        ...
        {
          title: t('REPORTS', 'LAPORAN'),
          items: [
            {
              label: t('Completed Reports', 'Laporan Selesai'),
              path: '/reports',
              icon: <FileText className="w-[18px] h-[18px]" />,
            },
          ],
      ...
      return [
        {
          ...
          items: [
            ...
            {
              label: t('User Management', 'Pengurusan Pengguna'),
              path: '/users',
              icon: <Users className="w-[18px] h-[18px]" />,
            },
            {
              label: t('Clinic Management', 'Pengurusan Klinik'),
              path: '/clinics',
              icon: <Building2 className="w-[18px] h-[18px]" />,
            },
            {
              label: t('Imaging Equipment', 'Peralatan Imbasan'),
              path: '/fleet',
        ...
        {
          title: t('OPERATIONS', 'OPERASI'),
          items: [
            {
              label: t('Patient Registry', 'Daftar Pesakit'),
            ...
            {
              label: t('AI Scheduler', 'Penjadual AI'),
              path: '/ai-scheduler',
        ...
        },
        {
          ...
          items: [
            {
              label: t('Announcements', 'Pengumuman'),
              path: '/announcements',
              icon: <Megaphone className="w-[18px] h-[18px]" />,
            },
            {
              label: t('System Settings', 'Tetapan Sistem'),
              path: '/settings',
              icon: <Settings className="w-[18px] h-[18px]" />,
            },
            {
              label: t('Audit Trail', 'Log Audit'),
              path: '/audit-logs',
              icon: <ScrollText className="w-[18px] h-[18px]" />,
            },
            {
              label: t('Recycle Bin', 'Tong Sampah'),
              path: '/recycle-bin',
              icon: <Trash2 className="w-[18px] h-[18px]" />,
            },
            {
              label: t('Infrastructure', 'Infrastruktur'),
              path: '/tech-stack',
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 bg-white border-r border-[#E2E8E6] flex flex-col h-full">

      {/* Logo */}
      <div className="px-4 py-3 border-b border-[#E2E8E6]">
      ...
      <nav className="flex-1 overflow-y-auto py-3 px-3">
        {groups.map((group, gi) => (
          <div
            ...
            className={gi > 0 ? 'mt-4' : ''}
          >
            <p className="px-3 mb-1.5 text-[10px] font-semibold text-[#6B8580] uppercase tracking-wider">
              {group.title}
            </p>
