    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        <div className="flex items-center gap-2">
          ...
          <span className="badge-purple font-mono text-xs font-bold">MO ADMISSION</span>
        </div>
        <p className="page-subtitle">Register a new patient record into the HealthGrid clinical database for Medical Officer referrals.</p>
      </div>
