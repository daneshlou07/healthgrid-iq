    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <span className="badge-purple font-mono text-xs font-bold">MO REFERRAL INTAKE</span>
        </div>
        <p className="page-subtitle">
          Medical Officer referral wizard &middot; Issue digital radiology request (MOH PER.SS-RA301).
        </p>
      </div>
