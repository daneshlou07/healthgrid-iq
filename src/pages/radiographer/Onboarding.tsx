...
export default function Onboarding() {
  ...
  const checklist = [
    ...
    { label: 'Equipment training certification', done: true },
    { label: 'Safety protocol acknowledgement', done: true },
  ];
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="card">
          ...
          <div className="space-y-3 text-sm">
            <div><span className="text-xs text-surface-500 uppercase">License Number</span><p className="text-surface-800 font-medium font-mono">RAD-2026-001</p></div>
            ...
            <div><span className="text-xs text-surface-500 uppercase">Affiliated Clinic</span><p className="text-surface-800">{currentUser?.deploymentLocationId ? 'Assigned' : 'Not assigned'}</p></div>
          </div>
        </div>
      </div>
