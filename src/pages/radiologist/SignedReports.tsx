  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative max-w-sm">
        ...
        <input type="text" placeholder="Search by case #, patient, or disease..." value={search} onChange={(e) => setSearch(e.target.value)} className="input-field pl-10" />
      </div>
            ...
            {filtered.map((r) => {
              ...
              return (
                <tr key={r.id} className="hover:bg-surface-100 transition-colors">
                  ...
                  <td className="table-cell text-xs text-surface-600">{caseItem?.disease || '—'}</td>
